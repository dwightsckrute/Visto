package com.dwightsckrute.visto.feature.lists.listEntry
...
import com.dwightsckrute.visto.core.ui.components.tiles.M3eButton
import com.dwightsckrute.visto.core.ui.components.tiles.M3eOutlinedButton
...
import com.dwightsckrute.visto.feature.lists.ListsViewModel
import com.dwightsckrute.visto.feature.lists.listEntry.ui.ListEntrySelectIconSheet
import com.dwightsckrute.visto.feature.lists.listEntry.ui.ListEntrySheet
...
fun ListEntryScreen(id: Long = -1L, navController: NavController) {
    ...
    LargeTopBarScaffold(
        title = if (id != -1L) "Actualizar lista" else localized("Crear lista", "Create list"),
        ...
        bottomBar = {
            ...
            BottomAppBar(
                ...
                Row(
                    ...
                    M3eButton(
                        text = if (id != -1L) localized("Actualizar lista", "Update list") else "Guardar lista",
                        onClick = {
                            viewModel.saveList(id != -1L, id)
                            SnackbarManager.show(AppLanguage.text("Lista guardada", "List saved"))
